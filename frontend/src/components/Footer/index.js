            ...
            <div>
                <nav className="footer__bar">
                    ...
                    <div className="built__with__container" >Built by:
                        <a href='https://github.com/danguai' className='built__with__logos'>
                            <img className='built__with__logos' src={require('../../images/logos/github.png')} />
                        </a>
                        <a href='https://www.linkedin.com/in/blancodaniel/' className='built__with__logos'>
                            <img className='built__with__logos' src={require('../../images/logos/linkedin.png')} />
                        </a>
                        <a href='https://www.instagram.com/danguai/' className='built__with__logos'>
                            <img className='built__with__logos' src={require('../../images/logos/instagram.png')} />
                        </a>
                        <a href='https://d-blanco.com/' className='built__with__logos'>
                            d-blanco.com
                        </a>
                    </div>
                </nav>
